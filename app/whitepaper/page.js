...
const allocationRows = [
  ['Presale', '5,000,000 ARTM3', '50%', 'Allocated through the verified presale contract.'],
  ['Liquidity', '2,000,000 ARTM3', '20%', 'Planned for launch; no liquidity position is currently created or locked.'],
  ['Growth fund', '1,500,000 ARTM3', '15%', 'Treasury-controlled reserve for future ecosystem activity.'],
  ['Treasury', '1,000,000 ARTM3', '10%', 'Treasury-controlled reserve for operations and long-term project needs.'],
  ['Team', '500,000 ARTM3', '5%', 'Locked onchain until 1 January 2028 at 00:00 UTC.'],
];

const risks = [
  ['Loss risk', 'ARTM3 can lose all value. Buyers should only use funds they can afford to lose.'],
...
const contractRows = [
  ['ARTM3 token', ARTEMIS_CONTRACTS.token, 'Fixed 10,000,000 supply; no post-deployment mint function.'],
  ['Presale contract', ARTEMIS_CONTRACTS.presale, 'ETH, USDT, and USDC support. Sale and claims are currently inactive.'],
  ['Team lock', ARTEMIS_CONTRACTS.teamLock, 'Holds 500,000 ARTM3; full release cannot occur before 1 January 2028 UTC.'],
];
      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-6 py-12 lg:grid-cols-[190px_minmax(0,1fr)] lg:py-16">
        ...
        <article className="min-w-0">
          ...
          <h1 className="mt-5 max-w-4xl text-4xl font-semibold leading-tight text-white md:text-6xl">
            The coin built for the next giant leap.
          </h1>
          <p className="mt-6 max-w-3xl text-lg leading-8 text-blue-100/75">
            ARTM3 is a fixed-supply Ethereum coin created for a rare cultural moment: humanity&apos;s planned return to
            the Moon. It combines a transparent onchain foundation with a long-term ambition to power a space-minded
            community, merchandise, digital collectibles, and future marketplace experiences.
          </p>
          ...
          <div className="mt-8 border-l-2 border-cyan-300 bg-cyan-300/10 px-5 py-4 text-sm leading-6 text-cyan-50/90">
            ...
            <p className="mt-2">
              ARTM3 is designed to be easy to verify, not just easy to talk about. Its fixed supply, token allocation,
          ...
          <Section id="summary" eyebrow="01 / Executive summary" title="A Moon-mission moment, built to last">
            <p>
              ARTM3 is an ERC-20 coin on Ethereum with a fixed maximum supply of 10,000,000 tokens. It is designed
              around the attention and optimism surrounding the planned Artemis III Moon mission, currently targeted
              by NASA for 2027. A finite supply gives the project a clear, easily verifiable foundation: no additional
              ARTM3 can be minted under the deployed token contract.
            </p>
            <p className="mt-4">
              The ambition is to meet this global Moon moment with a transparent community coin, then build reasons for
              that community to stay involved beyond a single launch window. Artemis aims to pursue exchange and
              liquidity opportunities around that period, but holding ARTM3 does not guarantee a listing, price,
          ...
          <Section id="project" eyebrow="02 / Project and intended utility" title="From Moon moment to Moon economy">
            <p>
              Artemis starts with a simple idea: a Moon mission will give people everywhere a reason to look up. ARTM3
              is intended to give that attention an onchain home. Over time, the project aims to explore ARTM3 as a
            ...
            <p className="mt-4">
              ...
              programme, or any government agency. Marketplace, merchandise, and partnership concepts remain future
          ...
          <Section id="technology" eyebrow="03 / Technology and transparency" title="Built on Ethereum. Open by design.">
            <p>
              ARTM3 is issued on Ethereum using a standard ERC-20 implementation. Ethereum is an established smart-
          ...
          <Section id="tokenomics" eyebrow="04 / Tokenomics" title="A finite supply for a long horizon">
            <p>
              There will only ever be 10,000,000 ARTM3. That hard ceiling gives the community a clear supply story and
            ...
            <div className="mt-5 grid gap-4 md:grid-cols-2">
              <div className="border border-emerald-300/20 bg-emerald-300/[0.06] p-4 text-sm leading-6 text-emerald-50/85">
                ...
                <p className="mt-2">The full 500,000 ARTM3 team allocation is held by the verified team-lock contract and cannot be released before 1 January 2028 at 00:00 UTC.</p>
              </div>
          ...
          <Section id="roadmap" eyebrow="05 / Roadmap and operations" title="Countdown to a bigger mission">
            <ol className="space-y-4 border-l border-cyan-300/25 pl-5">
              ...
              <li><strong className="text-white">Presale:</strong> activate the onchain sale when the project is ready, giving the first community members a transparent route to ARTM3 allocation.</li>
              <li><strong className="text-white">Moon window:</strong> pursue exchange and liquidity opportunities as Artemis III draws global attention to the Moon. These are commercial objectives, not commitments.</li>
              <li><strong className="text-white">Beyond the landing:</strong> test and develop the merchandise, collectible, and marketplace ideas that can make ARTM3 useful to a durable space-minded community.</li>
            </ol>
          </Section>

          <Section id="risks" eyebrow="06 / Material risks" title="Read before acquiring ARTM3">
          ...
          <Section id="disclosure" eyebrow="07 / Responsible disclosure" title="Excitement works better with trust">
            <p>
              Artemis is designed to communicate ambition without treating ambition as certainty. Regulation (EU)
